    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                try {
                    BluetoothPopUp mBluetoothPopUpUpActivity = (BluetoothPopUp) mContext;
                    mBluetoothPopUpUpActivity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
