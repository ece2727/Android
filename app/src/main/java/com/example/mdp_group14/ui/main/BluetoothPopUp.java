package com.example.mdp_group14.ui.main;
...
import com.example.mdp_group14.R;
...
public class BluetoothPopUp extends AppCompatActivity {
    ...
    public ListDeviceAdapter mNewDevlceListAdapter;
    public ListDeviceAdapter mPairedDevlceListAdapter;
    ...
    Runnable reconnectionRunnable = new Runnable() {
        ...
        public void run() {
            // Magic here
            try {
                if (BluetoothConnect.BluetoothConnectionStatus == false) {
        ...
        otherDevicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    mBluetoothConnection = new BluetoothConnect(BluetoothPopUp.this);
    ...
    public void toggleButtonScan(View view){
        ...
        if(mBluetoothAdapter != null) {
            ...
            for(BluetoothDevice d : pairedDevices){
                ...
                mPairedDevlceListAdapter = new ListDeviceAdapter(this, R.layout.device_adapter_view, mPairedBTDevices);
                pairedDevicesListView.setAdapter(mPairedDevlceListAdapter);
            }
        }
    }
    ...
    private void checkBTPermissions() {
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.Q){
            ...
            Log.d(TAG, "checkBTPermissions: No need to check permissions. SDK version < Q.");
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mNewDevlceListAdapter = new ListDeviceAdapter(context, R.layout.device_adapter_view, mNewBTDevices);
                otherDevicesListView.setAdapter(mNewDevlceListAdapter);
